"""Permit bounded as-of lineage without weakening flow-cell lineage."""

VERSION = 13
NAME = "feature_family_as_of_lineage"

_PERIOD_MATCH = """(
  substr(observation.period_end, 1, 10) BETWEEN value.period_start AND value.period_end
  OR (
